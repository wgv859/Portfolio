...
public class ContactListDaoInMemImpl implements ContactListDao {
    ...
    //primary key for Contacts in the database
    ...
    public List<Contact> searchContacts(Map<SearchTerm, String> criteria) {
        ...
        //if type Contact. That means that Predicates declared
        ...
        //Placeholder predicate - always return true. Used for
        ...
        //preidcate that ony returns true when it finds a match for the 
        //given term.
