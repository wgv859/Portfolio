 ...
 * @author wgv85
 */
public class AbilityDaoJdbcTemplateImpl implements AbilityDao {
    ...
    public void addAbility(Ability ability) {
        ...
        //the update method inserts the data from the Ability Object into into a row in the Ability database table.
        jdbcTemplate.update(PreparedStatements.SQL_INSERT_ABILITY, ability.getAbilityName(), ability.getAbilityDescription());
        ...
        int abilityId = jdbcTemplate.queryForObject(PreparedStatements.SQL_SELECT_LAST_INSERT_ID, Integer.class);
        
        //Use the abilityId generated by the database to set the Id of the Ability
    ...
    public void deleteAbility(int abilityId) {
        ...
        // first delete the bridge table relationship for this Ability
        jdbcTemplate.update(PreparedStatements.SQL_DELETE_ANOMALYABILITY_BY_ABILITY_ID, abilityId);
        
        // then delete the Ability
        jdbcTemplate.update(PreparedStatements.SQL_DELETE_ABILITY, abilityId);
    }
    ...
    public void updateAbility(Ability ability) {
        ...
        jdbcTemplate.update(PreparedStatements.SQL_UPDATE_ABILITY, ability.getAbilityName(), ability.getAbilityDescription(), ability.getAbilityId());
    ...
    public Ability getAbilityById(int abilityId) {
        ...
        try {
            // return Ability from the Ability table for specified Ability Model Object
            return jdbcTemplate.queryForObject(PreparedStatements.SQL_SELECT_ABILITY_BY_ID, new AbilityDaoJdbcTemplateImpl.AbilityMapper(), abilityId);
    ...
    public List<Ability> getAllAbilities() {
        ...
        // Return List of Abilities after using AbilityMapper and prepared statements to gather each Ability 
        // and its properties from the Database 
        return jdbcTemplate.query(PreparedStatements.SQL_SELECT_ALL_ABILITIES, new AbilityDaoJdbcTemplateImpl.AbilityMapper());
    }
    ...
    public List<Ability> getAbilitiesByAnomalyId(int anomalyId) {
        ...
        return jdbcTemplate.query(PreparedStatements.SQL_SELECT_ABILITIES_BY_ANOMALY_ID, new AbilityDaoJdbcTemplateImpl.AbilityMapper(), anomalyId);
    }
...
//***********************************************************************************
    ...
    private List<Ability> findAbilitiesForAnomaly(Anomaly anomaly) {
        ...
        // Use the prepared statement to return a List of every Ability associated with the supplied Anomaly Object
        return jdbcTemplate.query(PreparedStatements.SQL_SELECT_ABILITIES_BY_ANOMALY_ID, new AbilityDaoJdbcTemplateImpl.AbilityMapper(), anomaly.getAnomalyId());
    }
...
//***********************************************************************************
    ...
    private List<Organization> findOrganizationsForAnomaly(Anomaly anomaly) {
        ...
        return jdbcTemplate.query(PreparedStatements.SQL_SELECT_ORGANIZATIONS_BY_ANOMALY_ID, new AbilityDaoJdbcTemplateImpl.OrganizationMapper(), anomaly.getAnomalyId());
    }
...
//***********************************************************************************
    ...
    private List<Anomaly> findAnomaliesForSighting(Sighting sighting) {
        ...
        return jdbcTemplate.query(PreparedStatements.SQL_SELECT_ANOMALYSIGHTING_BY_SIGHTING_ID, new AbilityDaoJdbcTemplateImpl.AnomalyMapper(), sighting.getSightingId());
    }
    ...
    private List<Sighting> findSightingsForAnomaly(Anomaly anomaly) {
        ...
        return jdbcTemplate.query(PreparedStatements.SQL_SELECT_ANOMALYSIGHTING_BY_ANOMALY_ID, new AbilityDaoJdbcTemplateImpl.SightingMapper(), anomaly.getAnomalyId());
    }
