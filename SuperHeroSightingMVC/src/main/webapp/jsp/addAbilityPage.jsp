<%-- 
    Document   : addAbility
    Created on : May 29, 2019, 4:01:42 PM
    Author     : wgv85
--%>
...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <form class="form-horizontal" role="form" method="POST" action="addAbility">
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-8">
                        <input type="submit" class="btn btn-default" value="Add Ability"/>
                    </div>
                </div>
            </form>
