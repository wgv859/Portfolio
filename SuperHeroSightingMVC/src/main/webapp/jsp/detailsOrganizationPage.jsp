<%-- 
    ...
    Created on : May 30, 2019, 10:02:22 PM
    Author     : wgv85
--%>
    ...
    <body>
        <div class="container-fluid">
            ...
            <c:if test="${pageContext.request.userPrincipal.name != null}">
                ...
                <p>Description: ${organization.organizationDescription}</p>
                <p>Street: ${organization.organizationStreet}</p>
                <p>City: ${organization.organizationCity}</p>
                <p>State: ${organization.organizationState}</p>
                <p>Zip: ${organization.organizationZip}</p>
                <p>Phone: ${organization.organizationPhone}</p>
                <p>Email: ${organization.organizationEmail}</p>
                <br/>
                <p>Members of this Organization</p>
                <ul>
